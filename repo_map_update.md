...
- ✅ candy-buffer (step-02, PR #883)
- ✅ candy-layout (step-03, PR #884)
- ✅ candy-testing (step-04, PR #885)
- ✅ candy-mouse (step-05, PR #886)
- ✅ candy-input (step-06, PR #887)
- ✅ candy-fuzzy (step-07, PR #888)
- ✅ candy-async (step-08, PR #889)
- ✅ candy-core enhancements (step-09, PR #890)

### §344 Shared Components/Abstractions — covered by:
- Buffer/Cell value objects (PR #883 step-02)
- LayoutSolver interface (PR #884 step-03)
- FuzzyMatcher interface (PR #888 step-07)
- ProgramSimulator test harness (PR #885 step-04)
- Mouse Zone/Mark/Scan (PR #886 step-05)
- Input Driver/KeyEvent (PR #887 step-06)
- AsyncOps/CancellationToken (PR #889 step-08)
- DatabaseInterface + UndoActionType (PR #904 step-25)
- StyleSheet/BlockStack (PR #892 step-11)
- Buffer::diff() delta ANSI (PR #905 step-26)

### §368 Potential Consolidation Opportunities — covered by:
- Merge candy-forms + sugar-prompt testing → candy-testing golden-file (PRs #885/#907)
- Extract shared state machine from candy-vt → candy-ansi Parser (PRs #882/#899)
- Consolidate layout solvers → candy-layout (PR #884 step-03)
- Unify mouse hit-testing → candy-mouse (PR #886 step-05)
- Consolidate buffer rendering → candy-buffer (PR #883 step-02 + PR #905 step-26)
- Consolidate async patterns → candy-async (PR #889 step-08)
- Consolidate styling foundations → candy-sprinkles + candy-shine (PRs #891/#892)

### §386 Repeated Reinventions — covered by:
- Fuzzy matching (candy-shell, candy-forms, sugar-prompt, sugar-bits) → candy-fuzzy (PR #888 step-07, PR #912 step-33)
- Byte-loop ANSI parsing (sugar-spark, candy-hermit, candy-freeze) → candy-ansi (PR #882 step-01, PR #899 step-20)
- String-based layout → candy-layout (PR #884 step-03)
- Manual mouse coordinate tracking → candy-mouse (PR #886 step-05, PR #901 step-22)
- ReactPHP async inconsistency → candy-async (PR #889 step-08, PR #902 step-23)
- Golden file assertions (zero packages) → candy-testing (PR #885 step-04, PR #907 step-28)
- Vim mode (4 independent implementations) → unified in candy-forms (PR #903 step-24)
- Snapshot test pattern → candy-testing (PR #907 step-28)
- Terminal capability probing → candy-palette + TerminalProbe (PR #893 step-13, PR #908 step-29)
- God class construction → builder patterns (PR #904 step-25)

### Ecosystem-wide adoption sweep (Phase 6, steps 31–37)
- step-31 candy-pty: adopted candy-input + candy-ansi (PR #910)
- step-32 candy-tetris + candy-mines: adopted candy-buffer + candy-mouse + candy-testing (PR #911)
- step-33 sugar-skate + sugar-wishlist + sugar-stash: adopted candy-fuzzy (PR #912, hotfix PR #913)
- step-34 sugar-calendar + sugar-toast: adopted candy-buffer + candy-testing (PR #914)
- step-35 sugar-tick + sugar-post + candy-serve: adopted candy-async (PR #915)
- step-36 candy-flip + candy-kit + honey-bounce + honey-flap: adopted candy-testing (PR #916)
- step-37 catch-all: deferral sweep complete — no remaining actionable libs (PR #917, docs-only)
...
See docs/repo_map_update_followups.md for the full list (4 items: candy-metrics, candy-log, candy-zone, candy-mold — all deferred from step-37 catch-all).
